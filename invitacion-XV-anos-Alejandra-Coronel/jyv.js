...
(function() {
  ...
  // ============================================
  const init = () => {
    const deadline = 'Aug 13 2026 23:30:59 GMT-0500';
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const eventDetails = {
    title: "XV años de Alejandra Coronel",
    description: "Ceremonia religiosa: 16:00 - Cóctel de bienvenida 17:00 - Palabras de bienvenida y entrada de la quinceañera 17:30",
    location: "Rancho San Vicente, Quito, Ecuador",
...
//     document.getElementById("invitado").innerText = nombre;
  
//     document.getElementById("passesfull").innerText = pases;
    
//     // const mensaje = `Hola! Soy ${nombre} (${texto}) y confirmo ${pases} pases ✅`;
//     // document.getElementById("btnWhatsapp").href = 
//     //     "https://wa.me/593TU_NUMERO?text=" + encodeURIComponent(mensaje);
// });
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const palabraPases = parseInt(pases) === 1 ? "PASE" : "PASES";
    ...
    const textoEl = document.getElementById("pass-text");
    if (textoEl) textoEl.innerText = palabraPases;
    
    const passesEl = document.getElementById("passesfull");
...
function goToPage(){
    ...
    // var whatsapp_number = "&text=*Confirmación Boda Jaime y Vane 2026*" + "%0A" + 
    //     "✨ ¡Muchas gracias por confirmar! ✨" + "%0A" + 
    //     "Nos alegra muchísimo saber que nos acompañarás en este día tan especial." + "%0A" + 
    //     "¡Será un placer compartir este momento contigo! 💍💫" + "%0A" + 
    //     "_________________________" + "%0A" + "%0A" + 
